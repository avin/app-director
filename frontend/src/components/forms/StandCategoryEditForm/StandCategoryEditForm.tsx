...
import { StandCategoryEditFormInputs } from '@/types';
...
import styles from './StandCategoryEditForm.module.scss';
...
const StandCategoryEditForm = ({ id = 'standCategory-edit-form', onSubmit }: Props) => {
  ...
  } = useForm<StandCategoryEditFormInputs>({
    mode: 'onChange',
    defaultValues: {
  ...
  const processSubmit = useCallback(
    async (data) => {
      ...
      dispatch(setFormState({ formName: Form.EditStandCategory, formState: data }));
