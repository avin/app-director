...
import { Application, ApplicationCategory, StandCategory, Organization, Stand, User } from '@/types';
...
export const applicationCategoriesSelector = (state: RootState) => state.applicationCategories.entities;

export const standsSelector = (state: RootState) => state.stands.entities;

export const standCategoriesSelector = (state: RootState) => state.standCategories.entities;
...
export const applicationCategoryByIdSelector = (state: RootState, id: string): ApplicationCategory =>
  state.applicationCategories.entities[id];

export const standByIdSelector = (state: RootState, id: string): Stand => state.stands.entities[id];

export const standCategoryByIdSelector = (state: RootState, id: string): StandCategory =>
  state.standCategories.entities[id];
